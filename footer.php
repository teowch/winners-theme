      ...
      <div class="footer-content">
        <div class="fale-conosco">
          ...
          <div class="social-media">
            <a href="https://www.instagram.com/equipewinnersbr/" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.youtube.com/@winnerstvbr" target="_blank" rel="noopener noreferrer">
              ...
              <span>@winnerstvbr</span>
            </a>
          </div>
        </div>
        <div class="footer-bottom">
          <a href="https://www.dkmbank.com.br/" target="_blank" class="patrocinador">
            <img src="<?=get_template_directory_uri()?>/assets/images/logo-dkm-branca.png" class="patrocinador-logo">
          </a>
          <span style="margin-left: 20px;"></span>
          <p>&copy; <?php echo date('Y'); ?> Equipe Winners. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
    <?php wp_footer(); ?>
